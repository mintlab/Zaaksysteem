...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{ZAAKSYSTEEM_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{ZAAKSYSTEEM_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
zaaksysteem_server.pl - Catalyst Testserver

=head1 SYNOPSIS

zaaksysteem_server.pl [options]
