package Zaaksysteem::SchemaGM::Bedrijf;
...
__PACKAGE__->add_columns(
  ...
  {
    data_type => "integer",
    default_value => "nextval('bedrijf_id_seq'::regclass)",
    is_nullable => 0,
    size => 4,
  },
  "dossiernummer",
...
__PACKAGE__->add_unique_constraint("bedrijf_pkey", ["id"]);


# Created by DBIx::Class::Schema::Loader v0.04006 @ 2012-04-03 15:22:58
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:mJewrZoS+JXF5fzmfmGhQg
