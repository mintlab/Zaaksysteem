...
__PACKAGE__->add_columns(
  ...
  {
    data_type => "integer",
    default_value => "nextval('gm_natuurlijk_persoon_id_seq'::regclass)",
    is_nullable => 0,
    size => 4,
  },
...
__PACKAGE__->add_unique_constraint("gm_natuurlijk_persoon_pkey", ["id"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Gvv8r/8ZSGgmeSxLNXkN3A
