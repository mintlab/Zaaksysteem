package Zaaksysteem::Gegevens::ImportLigplaatsXml;
...
sub set_db_columns {
    ...
    $self->table_name('BagLigplaats');

    $self->db_cols({
            'xpath_group' => { 'bag_LVC:Woonplaats' => {
                   ...
                   # ''      => 'einddatum',
                    ...
                    'bag_LVC:ligplaatsStatus'                                       => 'status',

                    'bag_LVC:gerelateerdeAdressen' => {
                            'bag_LVC:hoofdadres/bag_LVC:identificatie'              => 'hoofdadres'
                        },
